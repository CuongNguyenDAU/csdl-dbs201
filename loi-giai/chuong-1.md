...
File này do người soạn viết tay. `tools/build_docs.py` đọc từng mục `## A1`, `## B2`…
rồi chèn thành khối gập ngay dưới đúng bài tương ứng trong `docs/chuong-1/bai-tap.md`.

Quy ước: **không đặt khối ```mermaid trong lời giải**. Material dựng sơ đồ vào shadow
DOM ngay khi trang tải; khối gập lúc đó còn đóng nên chiều rộng bằng 0 và sơ đồ ra
méo. Lược đồ trong lời giải viết bằng ký hiệu văn bản `TÊN(khóa, thuộc tính…)`.
